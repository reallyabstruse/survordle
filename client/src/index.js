    ...
    if (this.state.solution) {
      ...
      for (let i = 0; i < arr_solution.length; i++) {
        if (arr_guess[i] === arr_solution[i]) {
          this.addKeyboardColor(arr_guess[i], GREEN);
      ...
      for (let i = 0; i < arr_guess.length; i++) {
        ...
        for (let j = 0; j < arr_solution.length; j++) {
          if (arr_guess[i] === arr_solution[j]) {
            this.addKeyboardColor(arr_guess[i], YELLOW);
    ...
    return (
		<div className={classNames("game", { dark: this.state.settings.dark })}>
			...
			<div
			  ...
			  className={classNames("guessescontainer", { gameover: this.state.gameover })}
			>
				<div
				  className={classNames("message", { hidemessage: !this.state.showmessage, [this.state.messagecolor]: this.state.showmessage})}
				>
					{this.state.message}
				</div>
				<div
